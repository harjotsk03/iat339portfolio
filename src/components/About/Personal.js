      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div>
          <p className="text-engineer-text-primary text-opacity-60 poppins-regular text-sm lg:text-lg leading-relaxed mb-6">
            ...
            who believes in the power of software to transform lives. my journey
            in tech began with a curiosity about how digital tools shape our
            experiences and has evolved into a mission to create intuitive,
            impactful solutions.
          </p>
        ...
        <div>
          <p className="text-engineer-text-primary text-opacity-60 poppins-regular text-sm lg:text-lg leading-relaxed mb-6">
            ...
            perspective has guided my work on projects ranging from educational
            platforms to community-building applications.
          </p>
          <p className="text-engineer-text-primary text-opacity-60 poppins-regular text-sm lg:text-lg leading-relaxed">
